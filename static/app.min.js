...
b.appendChild(k)}h&&(k=document.createElement("button"),k.textContent="Reverse",k.addEventListener("click",function(b){b.preventDefault();b=d.value;d.value=h.value;h.value=b}),b.appendChild(k))}if(e){var u=document.getElementById("select_day");b=document.getElementById("time_when");u&&b&&(b=document.createElement("button"),b.textContent="Now",b.addEventListener("click",function(b){b.preventDefault();b=new Date;var c=u.parentElement.getElementsByClassName("select-items");c.length?c[0].children[Math.min(b.getDay(),
